...
cp fadc_lbaas.ini /etc/neutron/services/.
...
# Agent and FortiADC device driver
cd /tmp/fortiadc_lbaasv2/fadc_api
sudo pip install .
cd /tmp/fortiadc_lbaasv2/fortinet_openstack_agent
sudo pip install .
